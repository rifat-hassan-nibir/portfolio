...
const ProjectCard = ({ id, image, title, description, technologies }) => {
  return (
    <Link to={`/portfolio/project-details/${id}`} className="flex flex-col h-full">
      <div className="flex flex-col justify-between hover:scale-[103%] transition-all duration-300 h-full py-1 rounded-lg overflow-hidden shadow-lg bg-primary text-white">

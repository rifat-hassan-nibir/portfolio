...
const ProjectCard = ({ id, image, title, description, technologies }) => {
  return (
    <Link to={`/portfolio/project-details/${id}`} className="flex flex-col h-full">
      <div className="flex flex-col justify-between h-full rounded-lg overflow-hidden shadow-lg bg-primary text-white hover:scale-[103%] transition-all duration-300">
